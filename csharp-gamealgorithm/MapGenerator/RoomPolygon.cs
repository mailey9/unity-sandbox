...
//NOTE(용택):   일단 취소.. 의도는 Rect 의 합집합을 Concave Polygon Points + ClockWise 로 관리하려는 것... 이었는데,
...
namespace minorlife
{
    ...
    public class RoomPolygon
    {
        ...
        public void Append(Coord roomCoord)
        {

        }

        public bool Contains(Coord roomCoord)
        {
